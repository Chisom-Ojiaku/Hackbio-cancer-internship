...
The Plot function creates a scatter plot of log fold change vs. negative log of p-values.
- Points are colored red if the p-value is less than 0.05, indicating statistical significance.
- A horizontal blue dashed line is added to indicate the significance threshold.
